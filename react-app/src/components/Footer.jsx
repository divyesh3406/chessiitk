  ...
  return (
    <footer className="bg-surface-container-lowest border-t border-outline-variant/10 px-6 py-16 md:px-12 lg:px-20">
      ...
      <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
        ...
        {/* Brand Info */}
        {/* Adjust lg:col-span-4 to make this section wider or narrower */}
        <motion.div
          initial={{ opacity: 0 }}
        ...
        {/* Organization Links */}
        {/* Adjust lg:col-span-2 to change spacing/position */}
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true, margin: "-50px" }}
        ...
        {/* Connect Links */}
        {/* Because this section now has 3 sub-columns, it gets more space (lg:col-span-6) */}
        <motion.div
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          viewport={{ once: true, margin: "-50px" }}
        ...
        >
          <h5 className="mb-6 text-center text-sm font-label uppercase tracking-widest text-primary">
  Connect
</h5>
